              ...
              <div class="order-placed-dt">
                ...
                <div class="title585">
                  ...
                  <ul class="address-placed-dt1">
                    <li>
                      <p>
                        <i class="uil uil-map-marker-alt"></i>Address :<span
                          ><?php echo $row['user_local'] ?>,<?php echo $row['user_add'] ?>,<?php echo $row['city_name'] ?>,<?php echo $row['user_pin'] ?></span
                        >
                      </p>
                    </li>
                    <li>
                      <p>
                        <i class="uil uil-phone-alt"></i>Phone Number :<span
                          >+91<?php echo $row['user_mobile'] ?></span
                        >
                      </p>
                    </li>
                  </ul>
